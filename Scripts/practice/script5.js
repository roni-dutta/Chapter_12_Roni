var category,startList,orders,price,
...
function bagsList(){
	$.ajax({
		type:"GET",
		url:"http://localhost/chapter_12_Roni/htmlFiles/items.html",
...
function shoesList(){
	$.ajax({
		type:"GET",
		url:"http://localhost/chapter_12_Roni/htmlFiles/itemsShoes.html",
		success: function (html){
			var a = $(html),
				b = a.find("#cat2"),
				c = b.slice(startList,stopList);
